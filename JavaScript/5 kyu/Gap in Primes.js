...
// 3 the gap is 1. From 3 to 5 the gap is 2. From 7 to 11 it is 4. 
...
//     gap(6,100,110) --> nil or {0, 0} or ... : between 100 and 
//     110 we have 101, 103, 107, 109 but 101-107is not a 6-gap 
//     because there is 103in between and 103-109is not a 6-gap 
...
function gap(g, m, n) {
    ...
    for(let j = 0; j < prime.length -1; j++){
        if(prime[j+1] - prime[j] === g){
            return [prime[j], prime[j+1]];
        }
    }
