...
// to 3 the step is 1. From 3 to 5 the step is 2. From 7 to 11 it is 
// 4. Between 2 and 50 we have the following pairs of 2-steps primes:
...
// So this function should return the first pair of the two prime 
// numbers spaced with a step of g between the limits m, n if these 
// g-steps prime numbers exist otherwise nil or null or None 
// or Nothing or [] or "0, 0" or {0, 0} or 0 0 or "" (depending on the language).
...
// For Go: nil slice is expected when there are no step between m 
// and n. Example: step(2,4900,4919) --> nil
