...
// but not including, the number passed to your function. Or, in other 
// words, sum all the even Fibonacci numbers that are lower than the 
// given number n (n is not the nth element of Fibonacci sequence) 
// without including n.
