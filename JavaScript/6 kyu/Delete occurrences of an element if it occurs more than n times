...
// entire collection. However, Charlie doesn't like these sessions, since 
...
// motif at most N times. Luckily, Alice and Bob are able to encode the 
// motif as a number. Can you help them to remove numbers such that 
...
// since this would lead to 1 and 2 being in the result 3 times, and 
