...
// same data value occurs in many consecutive data elements) are 
...
// character sx ix times and concatening all those strings. Your run-length 
...
const runLengthEncoding = (str) =>{
    ...
    for(let i = 0; i < str.length; i++){
        let count = 0;
        if(str[i] === keys[keys.length - 1]) continue;
