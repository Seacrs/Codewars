...
// code is now mostly superseded by voice and digital data communication channels, it 
...
// service codes, the most notorious of those is the international distress signal SOS, that 
// is coded as ···−−−···. These special codes are treated as single special characters, and usually 
...
decodeMorse = function(morseCode){
    ...
    // Your code here
    return morseCode.split().map(x => x.trim()).map(el => {
        return el.split("   ").map(x=>{
