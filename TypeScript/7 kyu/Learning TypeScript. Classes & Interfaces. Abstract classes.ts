...
// contain an implementation and must be implemented in derived 
// classes. Abstract methods share a similar syntax to interface methods. 
// Both define the signature of a method without including a method 
// body. However, abstract methods must include the abstract keyword and may optionally include access modifiers.
...
// There is an old funny USSR's cartoon called "38 parrots" 
// (https://www.youtube.com/watch?v=iEHyrNX4IR8 - with English 
// subtitles). In this cartoon monkey and parrot measured boa... and they 
// found out that one boa is equal to 38 parrots or 5 monkeys.
