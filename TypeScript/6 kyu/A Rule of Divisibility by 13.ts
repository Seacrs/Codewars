...
// From now on the sequence is stationary (we always get 87) and the 
// remainder of 1234567 by 13 is the same as the remainder of 87 by 
// 13 ( i.e 9).

// Task:
// Write a function which processes this sequence of operations on an 
// integer n (>=0) and returns the stationary number.

// Examples
// for n = 1234567 it calculates 178, then 87, then 87 and returns 
// 87.
...
export function sum(n: number){
    ...
    return digits
            .reverse()
            .map((d, i) => d * pattern[i % pattern.length])
