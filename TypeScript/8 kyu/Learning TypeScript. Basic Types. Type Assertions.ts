...
// performs no special checking or restructuring of data. It has no 
// runtime impact, and is used purely by the compiler. TypeScript assumes 
// that you, the programmer, have performed any special checks that you need.
...
// The two samples are equivalent. Using one over the other is mostly 
// a choice of preference; however, when using TypeScript with JSX, only 
